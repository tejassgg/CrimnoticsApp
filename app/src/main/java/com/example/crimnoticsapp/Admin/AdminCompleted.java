...
public class AdminCompleted extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    com.example.crimnoticsapp.Admin.AdminCompletedPageAdapter AdminCompletedPageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminCompletedPageAdapter = new AdminCompletedPageAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
        viewPager.setAdapter(AdminCompletedPageAdapter);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 0 || tab.getPosition() == 1 || tab.getPosition() == 2) {
                    AdminCompletedPageAdapter.notifyDataSetChanged();
                }
            }
        ...
        navigationView.setCheckedItem(R.id.admin_nav_completed);
