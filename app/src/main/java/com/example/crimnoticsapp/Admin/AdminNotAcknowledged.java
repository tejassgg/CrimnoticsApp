...
public class AdminNotAcknowledged extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    com.example.crimnoticsapp.Admin.AdminNotAcknowledgedPageAdapter AdminNotAcknowledgedPageAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_not_acknowledged);
        ...
        AdminNotAcknowledgedPageAdapter = new AdminNotAcknowledgedPageAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
        viewPager.setAdapter(AdminNotAcknowledgedPageAdapter);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 0 || tab.getPosition() == 1 || tab.getPosition() == 2) {
                    AdminNotAcknowledgedPageAdapter.notifyDataSetChanged();
                }
            }
        ...
        navigationView.setCheckedItem(R.id.admin_nav_not_acknowledged);
