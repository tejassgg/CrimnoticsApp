...
public class AdminAcknowledged extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    com.example.crimnoticsapp.Admin.AdminAcknowledgedPageAdapter AdminAcknowledgedPageAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_acknowledged);
        ...
        AdminAcknowledgedPageAdapter = new AdminAcknowledgedPageAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
        viewPager.setAdapter(AdminAcknowledgedPageAdapter);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 0 || tab.getPosition() == 1 || tab.getPosition() == 2) {
                    AdminAcknowledgedPageAdapter.notifyDataSetChanged();
                }
            }
        ...
        navigationView.setCheckedItem(R.id.admin_nav_acknowledged);
