...
public class AdminUnderProgress extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    com.example.crimnoticsapp.Admin.AdminUnderProgressPageAdapter AdminUnderProgressPageAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_under_progress);
        ...
        AdminUnderProgressPageAdapter = new AdminUnderProgressPageAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
        viewPager.setAdapter(AdminUnderProgressPageAdapter);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 0 || tab.getPosition() == 1 || tab.getPosition() == 2) {
                    AdminUnderProgressPageAdapter.notifyDataSetChanged();
                }
            }
        ...
        navigationView.setCheckedItem(R.id.admin_nav_underProgress);
