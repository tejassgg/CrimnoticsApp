...
import com.example.crimnoticsapp.Admin.AdminFragments.AdminMissingScreenFrag;
import com.example.crimnoticsapp.HelperClasses.Missing;
import com.example.crimnoticsapp.R;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

public class AdminRecviewForMPAdapter extends FirebaseRecyclerAdapter<Missing,AdminRecviewForMPAdapter.myviewholder> {

    public AdminRecviewForMPAdapter(@NonNull FirebaseRecyclerOptions<Missing> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final Missing model) {
        ...
        holder.reportImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapperAdminMP,new AdminMissingScreenFrag(model.getName(),model.getAge(),model.getHeight(),model.getReportTime(),model.getLastSeen(),model.getGender(),model.getDescription(),strImage,model.getApplication(),model.getPostKey())).addToBackStack(null).commit();
            }
        });
    }
