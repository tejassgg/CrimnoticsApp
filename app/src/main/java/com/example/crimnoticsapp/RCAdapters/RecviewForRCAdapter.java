...
import com.bumptech.glide.Glide;
 ...
 import com.example.crimnoticsapp.ReportScreenFrag;
 import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

 public class RecviewForRCAdapter extends FirebaseRecyclerAdapter<Report, RecviewForRCAdapter.myviewholder> {

     public RecviewForRCAdapter(@NonNull FirebaseRecyclerOptions<Report> options) {
         super(options);
     }
     ...
     protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final Report model) {
         ...
         holder.img.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 ...
                 activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapperUserRC,new ReportScreenFrag(strImage,model.getType(),model.getAddress(),model.getReportDate(),model.getReportTime(),model.getDescription(),model.getApplication(),model.getPostKey())).addToBackStack(null).commit();
             }
         });
     }
